...
@Controller
public class AddCustomershareController {
	@Autowired
	...
	@RequestMapping("/toAddCustomershare")
	public ModelAndView toAddCustomershare(HttpServletRequest request) {
		...
		mav.setViewName("/AddCustomershare.jsp");
		return mav;
	}
}
